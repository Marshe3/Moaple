  ...
  <main class="board-container">
    <div class="board-box">
      <div class="board-scroll insert">
        <form id="postForm" class="form" action="boardInsert.do" method="post" enctype="multipart/form-data" novalidate>
	      ...
	      <div class="row required">
	        ...
	        <div class="field">
	          <input type="text" value="<%= loginUser.getName() %>" readonly style="background-color: #f5f5f5; cursor: not-allowed;" />
	      ...
	      <div class="row required">
	        <div class="label">작성자</div>
	        <div class="field">
	          <input type="text" value="로그인이 필요합니다" readonly style="background-color: #ffe6e6; cursor: not-allowed;" />
          ...
          <div class="row">
            ...
            <div class="field">
              <div class="filebox">
                ...
                <button type="button" class="-file" id="fileBtn">파일 선택</button>
          ...
          <!-- 하단 버튼 -->
          <div class="actions">
            <a href="boardList.do"><button type="button" class="btn" id="goList">목록</button></a>
      ...
      <script>
        ...
        fileIn.addEventListener('change', () => {
          fileName.textContent = (fileIn.files && fileIn.files.length)
            ? (fileIn.files.length === 1 ? fileIn.files[0].name : `${fileIn.files.length}개 파일 선택`)
            : '선택된 파일 없음';
        });
